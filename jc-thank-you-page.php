...
?>
	<main id="primary" class="site-main jc-thank-you-page u-margin-bottom--64">

		<article class="jc-thank-you-page_article u-text-center u-margin-bottom--32">
			...
			<h1 class="jc-h3 u-margin-bottom--32">Thank You</h1>

			<p>You may now close this window, or</p>

			<a class="jc-link--prime u-margin-bottom--64" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
